...
I used AI as a tutor during the process rather than treating generated commands as a substitute for understanding the environment.

My goal was to reach the point where I could explain what each component was doing, why it was configured that way, how I verified it was working, and how I would troubleshoot it if it failed.
